...
<header>
            ...
            <div class="wrapper">
                ...
                <nav>
                    <ul class="menu">
                        ...
                        <li><a class="active" href="category.php">Menu</a></li>
                        <li><a href="catalogue.php">Catalogue</a></li>
                        <li><a href="#">Profile</a></li>
                        <li><a href="#">ViewOrder</a></li>
    ...
    <div class="row-bot">
        <div class="row-bot-bg">
            <div class="main">
                <h2>Indian Food <span> Menu's </span></h2>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="main">
        <div class="container">
            ...
            <div id="slider-2">
                <div>
                    <div class="p4">
                        <figure><a class="lightbox-image" href="dal.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="dal.jpg" alt=""></a></figure>
                        <h5>Masoor Dal </h5>
                        ...
                        <a class="button-1" href="checkout.php">Order</a> </div>
                    <figure><a class="lightbox-image" href="1.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="1.jpg" alt=""></a></figure>
                    <h5> Tuar Dal </h5>
                    <p class="p1">Nobis eleifend option congue nihil imperdiet doming quod mazim plac<br>
                        erat facer possim.</p>
                    <p class="p2"><strong class="color-2">Price: $12.95</strong></p>
                    <a class="button-1" href="#">Order</a> </div>
                <div>
                    <div class="p4">
                        <figure><a class="lightbox-image" href="2.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="2.jpg" alt=""></a></figure>
                        <h5>Black Dal</h5>
                        ...
                        <a class="button-1" href="#">Order</a> </div>
                    <figure><a class="lightbox-image" href="3.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="3.jpg" alt=""></a></figure>
                ...
                <div>
                    <div class="p4">
                        <figure><a class="lightbox-image" href="4.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="4.jpg" alt=""></a></figure>
                ...
                <div>
                    <div class="p4">
                        <figure><a class="lightbox-image" href="nal.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="nal.jpg" alt=""></a></figure>
                ...
                <div>
                    <div class="p4">
                        <figure><a class="lightbox-image" href="rasmalai.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="rasmalai.jpg" alt=""></a></figure>
                        <h5>Nam liber tempor cusoluta </h5>
                        <p class="p1">Nobis eleifend option congue nihil imperdiet doming quod mazim plac<br>
                            erat facer possim.</p>
                        <p class="p2"><strong class="color-2">Price: $12.95</strong></p>
                        <a class="button-1" href="#">Order</a> </div>
                    <figure><a class="lightbox-image" href="parata.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="parata.jpg" alt=""></a></figure>
                    <h5>Nam liber tempor cusoluta </h5>
                    <p class="p1">Nobis eleifend option congue nihil imperdiet doming quod mazim plac<br>
                        erat facer possim.</p>
                    <p class="p2"><strong class="color-2">Price: $12.95</strong></p>
                ...
                <div>
                    <div class="p4">
                        <figure><a class="lightbox-image" href="download.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="download.jpg" alt=""></a></figure>
                        <h5>Lorem ipsum dolor</h5>
                        <p class="p1">Consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna.</p>
                        <p class="p2"><strong class="color-2">Price: $9.50</strong></p>
                        <a class="button-1" href="#">Order</a> </div>
                ...
                <div>
                    <div class="p4">
                        <figure><a class="lightbox-image" href="kheeer.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="kheeer.jpg" alt=""></a></figure>
                        <h5>Sed diam nonummy nibh</h5>
                        <p class="p1">Euismod tincidunt ut laoreet dolore magna aliquam erat volutpat wisi<br>
                            enim ad minim.</p>
                        <p class="p2"><strong class="color-2">Price: $15.95</strong></p>
