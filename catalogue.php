    ...
    <div class="container">
      ...
      <div id="slider-2">
        <div>
          ...
          <figure><a class="lightbox-image" href="biryani.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="biryani.jpg" alt=""></a></figure>
          <h5>Nam liber tempor cusoluta </h5>
          <p class="p1">Nobis eleifend option congue nihil imperdiet doming quod mazim plac<br>
            erat facer possim.</p>
          <p class="p2"><strong class="color-2">Price: $12.95</strong></p>
        ...
        <div>
          <div class="p4">
            <figure><a class="lightbox-image" href="curry.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="curry.jpg" alt=""></a></figure>
            ...
            <a class="button-1" href="#">Add to Cart</a> </div>
          <figure><a class="lightbox-image" href="idli.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="idli.jpg" alt=""></a></figure>
          <h5>Lorem ipsum dolor</h5>
          <p class="p1">Consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna.</p>
          <p class="p2"><strong class="color-2">Price: $9.50</strong></p>
          <a class="button-1" href="#">Add to Cart</a> </div>
        <div>
          <div class="p4">
            <figure><a class="lightbox-image" href="keer.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="keer.jpg" alt=""></a></figure>
            ...
            <a class="button-1" href="#">Add to Cart</a> </div>
          <figure><a class="lightbox-image" href="laddu.jpg" data-gal="prettyPhoto[prettyPhoto]"><img src="laddu.jpg" alt=""></a></figure>
          <h5>Sed diam nonummy nibh</h5>
          <p class="p1">Euismod tincidunt ut laoreet dolore magna aliquam erat volutpat wisi<br>
            enim ad minim.</p>
          <p class="p2"><strong class="color-2">Price: $15.95</strong></p>
